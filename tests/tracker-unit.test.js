...
describe('readStdin', () => {
  ...
  test('does not throw when called', () => {
    // readStdin reads from /dev/stdin which will be empty in test environment
    expect(() => readStdin()).not.toThrow();
  });
});
...
describe('main', () => {
  ...
  test('does not throw when called', () => {
    // main() reads from stdin which will be empty in test environment
